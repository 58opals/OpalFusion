...
| Inbound fan-in | The attempt transport owner issues the role-complete mailbox groups once; relay fan-in starts and drains them; ingress authenticates recipients; the journal and runtime own admitted replay and typed delivery | Fan-in preserves source order and source loss. Concrete Tor proof, durable storage, and full runtime recovery remain external. |
