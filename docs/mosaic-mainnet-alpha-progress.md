...
Status: `in progress` as of 2026-08-23. G3 closure makes the integrated private session available for assurance. Wallet implementation `c0c182e5ef5a451d54e9f1a7eed6077cd2b21f81`, recorded by Wallet evidence commit `c7f8791a70ed29c0a82d522d89b7fafe377654b0`, resolves the local Release/preview blocker with a deterministic preview-boundary scan and one dependency-locked macOS Release build. Repository-owned exact-graph CI, vectors, fuzzing, simulator faults, multi-device and supported-environment traffic-analysis evidence, privacy-safe observability, runbooks, review packets, and independent dispositions remain open.
