...
Status: `in progress` as of 2026-08-23. G3 closure makes the integrated private session available for assurance. Wallet production source `6fcfca789087f77ec556b22feec37e7b7226ad1d` routes a closed aggregate lifecycle signal set through first-party OpalDiagnostics without a direct Wallet-to-OpalFusion dependency or secret-bearing fields. Wallet test-control revision `d0f232fb998730fad6282b536d51b6b4c5e210c9` produced the preserved 3/3 bounded result in 7.47 seconds; successor `11ae405a1d6cf894934f512ef1e5b981672b6c19` changed only the watchdog to enforce a 60-second wall-clock ceiling, so unchanged tests were not rerun. The production source passed one dependency-locked Release build in approximately 186 seconds. Wallet evidence revision `e894f921b048a84587a616ccdf57dc81a73fa707` adds 62 passing locally verified golden-vector tests and a consolidated partial fault record with 106 passing focused tests; manifest revision `27efcff54916d8955895289fed4980fbcd0cf693` keeps only the OpalFusion runtime/overflow fault subset held. OpalFusion private test revision `7003e40a695912a0e8d0bf15ca0a2c925327c9fc` contains 92 positive parser seeds across 24 focused bodies, including digest-pinned transport and recovery fixtures, with no final combined rerun. Machine-checked maps assign all 52 low-level implementation files to covered and account for all nine public transport composite byte parents; Wallet's cross-repository campaign adds ten seeds across four bodies and maps the consumed OpalCrypto contracts, bringing the frozen graph to 102 positive seeds across 28 bodies. `Sources`, `Package.swift`, and `Package.resolved` remain byte-identical to public runtime `79ba5f91449b2c0d5cd6ec73c38fafd58cae0b46`. Exact-graph package CI execution, independent parser-campaign sufficiency review, held OpalFusion fault selectors, multi-device and supported-environment traffic analysis, signed isolated runbook verification, reviewer assignments, independent UXC and safe-claim verification, and every other independent disposition remain open.

The [bounded parser-mutation evidence](mosaic-g4-parser-mutation-evidence-2026-08-23.md), [parser-root registry](mosaic-g4-parser-root-registry-2026-08-23.md), and [machine root map](mosaic-g4-parser-root-map-2026-08-23.txt) record the exact results, dispositions, gaps, and non-proofs. Runtime-generated transport-bootstrap shapes that crossed the ordinary 60-second ceiling were not retried unchanged; the replacement digest-pinned first-party fixture restores the exact proof in 12.592 seconds and keeps each final transport mutation selector within the ceiling.

The private [G4 Independent Review Packet](mosaic-g4-independent-review-packet-2026-08-23.md) freezes seven non-self-certifying lanes and the exact source and evidence map, while the [G4 Findings Register](mosaic-g4-findings-register.md) records every lane as unassigned and preloads the known evidence gaps without treating them as independent findings. Its 2026-08-31 refresh binds OpalFusion runtime `3fd91a603b03bc59eecf0f3be6596fef8cfafde7`, Wallet source `1370b7ddec32a047c2d2c3c2d5885a122fa40736`, Wallet local closure evidence `2b7b8e6b1c01faae80ce7f2a41ff996d96448af2`, current OpalBase `b48ee57c32793f65fe4a0c6b3e46b445dbf5fb0f`, and the locally passing successor fault selectors. Packet preparation is complete only when the successor Wallet manifest names the OpalFusion commit containing that refresh; reviewer assignment, review work, remediation, retest, and every independent disposition remain open.
