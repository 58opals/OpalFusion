...
Status date: 2026-08-19. This is a non-normative implementation record; the protocol profile, security model, and private-deployment contract remain authoritative.
...
Status: `in progress` as of 2026-08-19. Fusion `2dc1adc952975f160cc1eb465e761a081f599afa`, Base `8694c1645fc164b9b3968d5e20f93f3975917310`, and Crypto `cc51fc436c95381dfce25fd3f04377d6c29a17f3` form the exact fetchable package graph without changing frozen alpha.4 or alpha.5 bytes. Fusion, Base, and Crypto are published on public `develop`; Base pins exact public revisions and the clean public-URL package lanes pass. Explicit approval of the private-deployment.1 semantic decisions, the complete application dependency graph, and every release gate remains open; no G0 closure is claimed.
