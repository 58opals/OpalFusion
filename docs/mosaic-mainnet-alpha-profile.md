...
- production relay and mailbox execution that supplies the frozen ingress with recipient capabilities, merges exact duplicate signed events from three Tor-routed relays, persists replay/disposition state, and preserves terminal and cancellation ordering without exposing contributor identities;
