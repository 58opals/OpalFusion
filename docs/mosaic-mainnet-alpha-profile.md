...
- a production previous-output source wired into executable composition, durable encrypted attempt journal loading, crash recovery execution, app-owned broadcast policy, and a mainnet-disabled end-to-end host integration proof;
