...
- production mailbox ingress into the paired runtime session, executable runtime-driver integration, and production composition of the internal failure-aware coordinator with sealed mainnet material and host-result provenance;
