...
| OpalFusion G4 test-only harness | `103c85918e84328600b876647c4c17f8951d0dc4` | First-party bounded deterministic mutation campaign for 75 parser seeds across twelve focused test bodies plus a machine-checked 52-file implementation registry; production source, manifest, and lockfile remain byte-identical to the runtime row |
| OpalFusion G4 parser evidence | `c4bc5568bca15b5778387ab6087d1cc2459c64fe` | Machine-checked one-to-one root map for all 52 implementation files: 41 covered, three partial recovery variants, and eight transport-bootstrap closure-budget files; every-parser closure remains open |
