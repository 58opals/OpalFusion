...
| OpalFusion source status before this packet | `3fd91a603b03bc59eecf0f3be6596fef8cfafde7` | Private `draft` and public `develop` identify the hardened runtime candidate; public `main` and release tags remain untouched |
