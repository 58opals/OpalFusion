...
| OpalFusion G4 test-only harness | `b3f4e2329fa7a53d175da462eb0aa2776dd8087c` | First-party bounded deterministic mutation campaign for 72 parser seeds across eleven focused test bodies plus a machine-checked 52-file implementation registry; production source, manifest, and lockfile remain byte-identical to the runtime row |
