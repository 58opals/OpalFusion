...
| OpalFusion G4 test-only harness | `f2ecfe8638434ad2b5e8c941edef624ce9132532` | First-party bounded deterministic mutation campaign for 70 parser seeds across ten focused test bodies plus a machine-checked 52-file implementation registry; production source, manifest, and lockfile remain byte-identical to the runtime row |
