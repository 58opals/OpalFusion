...
| OpalFusion G4 test-only harness | `836dd517efc12f12c5f348caf7031a4520c1032c` | First-party bounded deterministic mutation campaign for 54 parser seeds across five focused test bodies; production source, manifest, and lockfile remain byte-identical to the runtime row |
