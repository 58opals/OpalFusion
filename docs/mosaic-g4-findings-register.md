...
| `G4-GAP-003` | Parser fuzz | Locally verified for the frozen graph: 92 OpalFusion seeds across 24 bodies, 52/0/0 low-level map, nine mapped composite parents with passing-evidence parity, and ten additional Wallet/OpalBase seeds across four bodies with consumed OpalCrypto roots mapped transitively | Preserve both freshness maps and affected selectors; independent reviewers must assess whether the deterministic first-party campaign is sufficient for the bounded private-alpha gate |
