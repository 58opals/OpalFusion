...
if [ "$map_count" -ne 52 ] || [ "$covered_count" -ne 41 ] || [ "$partial_count" -ne 3 ] || [ "$closure_count" -ne 8 ]; then
...
echo "Mosaic G4 parser root registry passed (52 files: 41 covered, 3 partial variants, 8 closure-budget)"
