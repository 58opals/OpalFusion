...
- [Mosaic G4 Parser-Root Registry](docs/mosaic-g4-parser-root-registry-2026-08-23.md): machine-checked low-level implementation-file surface, current first-party root accounting, composite and cross-repository gap queue, and closure rule.
