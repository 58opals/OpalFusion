...
- [Mosaic G4 Parser-Mutation Evidence](docs/mosaic-g4-parser-mutation-evidence-2026-08-23.md): exact test-only revision, first-party mutation and positive-variant design, focused results, production-tree parity, frozen-graph closure, and non-proofs.
- [Mosaic G4 Parser-Root Registry](docs/mosaic-g4-parser-root-registry-2026-08-23.md): machine-checked 52-file low-level surface, nine-parent transport composite map, application-owned cross-repository accounting, and future-drift rule.
