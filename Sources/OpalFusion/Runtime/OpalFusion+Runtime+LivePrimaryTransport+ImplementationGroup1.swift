// OpalFusion+Runtime+LivePrimaryTransport+ImplementationGroup1.swift
...
extension OpalFusion.Runtime.LivePrimaryTransport {
    ...
    func recordPrimaryConnectionEvent(
